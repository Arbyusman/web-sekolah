...
const KTUpdateActivityDocumentation = (() => {
    const editModal = $('#kt_modal_edit_activity_documentation');
    const editForm = editModal.find('#kt_modal_edit_activity_documentation_form');
    ...
    const show = () => {
        $(document).on('click', '.edit-activity-documentation-btn', function () {
