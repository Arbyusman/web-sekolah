...
const KTUpdateActivityCategory = (() => {
    const editModal = $('#kt_modal_edit_activity_category');
    const editForm = editModal.find('#kt_modal_edit_activity_category_form');
    ...
    const show = () => {
        $(document).on('click', '.edit-activity-category-btn', function () {
            const id = $(this).data('id');
            $.get(`/activity/categories/${id}`, function (data) {
                fv.resetForm(true);
                ...
                if (status === 'Valid') {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            Swal.fire('Updated!', response.message || 'Kategori kegiatan berhasil diperbarui.', 'success');
                        },
                        error: function (xhr) {
