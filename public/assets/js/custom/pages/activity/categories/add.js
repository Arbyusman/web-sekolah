...
const KTAddActivityCategory = (() => {
    const addModal = $('#kt_modal_add_activity_category');
    const addForm = addModal.find('#kt_modal_add_activity_category_form');
